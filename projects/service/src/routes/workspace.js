...
router.post('/demands', async (req, res, next) => {
  try {
    ...
    const task = {
      ...
      flowSteps: [
        { sequence: 0, title: '需求分析', state: '进行中 · 当前', status: 'current' },
        { sequence: 1, title: '原型编写', state: '未开始 · 锁定', status: 'locked' },
        { sequence: 2, title: '文档移交', state: '未开始 · 锁定', status: 'locked' },
        { sequence: 3, title: '交付', state: '未开始 · 锁定', status: 'locked' },
      ],
      messages: [],
      documents: [],
      conversations: [],
